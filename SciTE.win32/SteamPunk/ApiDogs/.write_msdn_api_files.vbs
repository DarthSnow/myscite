...
dim sFileName
  ...
  Set oFile_links = oFso.OpenTextFile("msdn.wsh.fnc.raw", 1, True) ' forRead, CreateFlag
  sFileName ="wsh_fnc_11_2015.api.raw"
...
' --- Add a Dot if none found and objects name isnt already in Apis Name.
    ...
    ofile_Api.Write sApiPrefix _
    & oEntry("LinkName") & oEntry("LinkParams") & " " _
	& "---- \t\n" _
