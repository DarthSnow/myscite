...
' Link MSHTML Objekt: http://msdn.microsoft.com/en-us/library/aa741322%28v=vs.85%29.aspx
...
' Javascript Objects https://msdn.microsoft.com/en-us/library/7sw4ddf8(v=vs.94).aspx
  'sFolder = "h:\msdn_js_obj"
  'sFileName = "h:\msdn.js.obj.raw"
     
' ---  Javascript Properties https://msdn.microsoft.com/en-us/library/xyad316h(v=vs.94).aspx
' ---  wscript https://msdn.microsoft.com/en-us/library/5ahda31z(v=vs.84).aspx
  ' sFolder = "msdn_wsh_obj"
  ' sFileName ="msdn.wsh.obj.raw

'--- ' VbScript Functions https://msdn.microsoft.com/en-us/library/307330xe%28v=vs.84%29.aspx

' --- vba toc https://msdn.microsoft.com/en-us/library/office/jj692818.aspx
