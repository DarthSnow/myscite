...
package.path = package.path .. ";"..defaultHome.."//Extensions//lua-modules//lua//?.lua;"
package.path =  package.path ..";"..defaultHome.."//Extensions//scite-debug//scite_lua//?.lua;"
package.path =  package.path ..";"..defaultHome.."//Extensions//scite-debug//remDebug//?.lua;"

package.cpath = package.cpath .. ";"..defaultHome.."//Extensions//lua-modules//c//?.dll;"
package.cpath = package.cpath .. ";"..defaultHome.."//tools/lua/?.dll;"
...
scite_require 'SciTEStartup.lua'
