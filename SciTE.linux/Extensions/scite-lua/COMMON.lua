...
--package.path  = props["SciteDefaultHome"].."//Extensions//lua-modules//lua//?.lua;"..package.path
--package.cpath = props["SciteDefaultHome"].."//Extensions//lua-modules//c//?.dll;"..package.cpath

dofile (props["SciteDefaultHome"].."//Extensions//scite-lua//URL_detect.lua")
dofile(props["SciteDefaultHome"]..'//Extensions//eventmanager.lua')
